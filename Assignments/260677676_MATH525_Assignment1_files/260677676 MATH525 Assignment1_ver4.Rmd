---
title: "260677676 MATH525 Assignment 1 ver4"
output:
...
$$
So indeed it is a minimum as long as $k\geq 0$, but by the nature of cost function it should be nonnegative.
...
$$
For the other case, let $S_{N-1-n}^*$, $S^*_{N-n}$ be any  particular sets constructed by following scheme.
$$
...
$$
P(S^*_{N-n}) = P(S^*_{N-n}|N \in S^*_{N-n}) P(N \in S^*_{N-n}) = \frac{1}{{N-1 \choose n-1}} \frac{{N-1\choose n-1}}{{N \choose n}} = \frac{1}{{N \choose n}}
$$
